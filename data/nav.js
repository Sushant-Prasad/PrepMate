  ...
  <nav class="bg-white shadow-sm fixed top-0 inset-x-0 z-50" id="nav">
      ...
      <div class="flex justify-between h-16 items-center">
        ...
        <div class="flex items-center">
          <a href="index.html" class="">
            <img src="image/logo.png" alt="PrepMate Logo" id="logo"/>
          </a>
          <div class="hidden lg:flex space-x-8 ml-6">
            ...
            <a href="company-prep.html" class="text-green-600 hover:text-green-800 hover:border-b-2 border-green-500">Company Prep</a>
          </div>
        </div>
        ...
        <div class="flex items-center">
          ...
          <div class="hidden lg:flex items-center space-x-4 mr-4">
            <div class="flex items-center text-yellow-600">
              <span class="text-xl mr-1"><a href="dsa-streak.html">🔥</a></span><span class="text-sm font-medium">5</span>
            </div>
            <div class="flex items-center text-blue-600">
              <span class="text-xl mr-1"><a href="aptitude-streak.html">📈</a></span><span class="text-sm font-medium">3</span>
            </div>
          </div>

          <!-- Login - Desktop -->
          <div class="hidden lg:block">
            <button class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md"><a href="login.html">Login</a></button>
          </div>
    ...
    <div id="mobileMenu" class="hidden lg:hidden inset-0 bg-white z-40 pt-2  absolute top-0 h-max">
      <div class="space-y-4 h-max bg-white px-5 pb-4">
        ...
        <!-- Nav Links -->
        <a href="/study-rooms" class="block text-lg text-green-600 hover:bg-green-50 px-4 py-2 rounded-lg">Study Rooms</a>
        <a href="/dsa" class="block text-lg text-green-600 hover:bg-green-50 px-4 py-2 rounded-lg">DSA</a>
        <a href="/aptitude" class="block text-lg text-green-600 hover:bg-green-50 px-4 py-2 rounded-lg">Aptitude</a>
        <a href="/company-prep" class="block text-lg text-green-600 hover:bg-grlgn-50 px-4 py-2 rounded-lg">Company Prep</a>
        ...
        <div class="flex justify-center space-x-6 py-4">
          <div class="flex items-center text-yellow-600">
            <span class="text-xl mr-2">🔥</span><span class="text-base font-medium">5 day streak</span>
          </div>
          <div class="flex items-center text-blue-600">
            <span class="text-xl mr-2">📈</span><span class="text-base font-medium">3 day streak</span>
          </div>
        </div>

        <!-- Login -->
        <button class="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-md">Login</button>
      </div>
    </div>
  </nav>
