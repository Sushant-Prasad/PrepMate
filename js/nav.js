  ...
  <nav class="bg-white shadow-sm fixed top-0 inset-x-0 z-50" id="nav">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden lg:flex items-center space-x-4 mr-4">
            ...
            <div class="flex items-center text-blue-600">
              <span class="text-xl mr-1"><a href="./aptitude-streak.html"><i class="fa-solid fa-brain"></i></a></span><span class="text-sm font-medium">3</span>
            </div>
          </div>
    ...
    <div id="mobileMenu" class="hidden lg:hidden inset-0 bg-white z-40 pt-2 absolute top-0 h-max">
      <div class="space-y-4 h-max bg-white px-5 pb-4">
        ...
        <a href="./companies.html" class="block text-lg text-green-600 hover:bg-green-50 px-4 py-2 rounded-lg">Company Prep</a>
        ...
        <div class="flex justify-center space-x-6 py-4">
          ...
          <div class="flex items-center text-blue-600">
            <span class="text-xl mr-2"><a href="./aptitude-streak.html"><i class="fa-solid fa-brain"></i></a></span><span class="text-base font-medium">3 day streak</span>
          </div>
        </div>
